...
type Payslip struct {
	ID            uint           `gorm:"primaryKey" json:"id"`
	UserID        uint           `gorm:"not null;index:idx_payslip_user_year_month,priority:1" json:"user_id"`
	User          User           `gorm:"foreignKey:UserID" json:"user,omitempty"`
	Month         int            `gorm:"not null;index:idx_payslip_user_year_month,priority:2" json:"month"` // 1-12
	Year          int            `gorm:"not null;index:idx_payslip_user_year_month,priority:3" json:"year"`
