...
import { Target, TrendingUp, CheckCircle2, Clock, Plus, BarChart3 } from "lucide-react";
  ...
  return (
    <div className="p-10">
      <div className="flex items-center justify-between gap-4 mb-10">
        ...
        <button className="flex items-center gap-2 bg-purple-600 hover:bg-purple-500 text-white px-5 py-2.5 rounded-xl transition-all shadow-lg shadow-purple-600/20 font-medium">
          <Plus size={18} />
          New Goal
        </button>
      </div>
